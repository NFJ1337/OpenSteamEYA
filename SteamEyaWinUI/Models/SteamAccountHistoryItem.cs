...
public sealed partial class SteamAccountHistoryItem : INotifyPropertyChanged
{
    ...
    /// <summary>是否由“导入白号”流程添加；新的账号管理页仅显示此标记的账号。</summary>
    public bool IsWhiteAccount { get; set; }
    ...
    [JsonIgnore]
    public Visibility CardActionVisibility => IsWhiteAccount ? Visibility.Visible : Visibility.Collapsed;
    ...
    [JsonIgnore]
    public Visibility CooldownHighlightVisibility => HasLiveCooldown ? Visibility.Visible : Visibility.Collapsed;
    ...
    public void NotifyCooldownTick()
    {
        ...
        handler(this, new PropertyChangedEventArgs(nameof(CooldownHighlightVisibility)));
    }
