...
/// 落在当前数据目录的 logs\steameya.log，超过 1 MB 滚动一个 .1 备份。
...
internal static class AppLog
{
    ...
    public static string LogFilePath => Path.Combine(LogDirectory, "steameya.log");

    private static string LogDirectory => Path.Combine(AppPaths.DataRoot, "logs");
